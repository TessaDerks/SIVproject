...
def watershed2(image):
    ...
    print(np.unique(markers))
    img[markers==-1]=[255,0,0]
    img[markers==2]= [255, 128, 0]
    img[markers==3]= [255, 128, 0]
    img[markers==4]= [255, 128, 0]
    #img[markers==1]= [0,0,255]
    img[markers==5]= [255, 128, 0]
    img[markers==6]= [255, 128, 0]
    img[markers==7]= [255, 128, 0]
    img[markers==8]= [255, 128, 0]
    img_2 = np.zeros_like(image)
    img_2[markers==1]= [153, 104, 255]

    #return img, unknown, sure_fg
    return img, unknown, img_2
